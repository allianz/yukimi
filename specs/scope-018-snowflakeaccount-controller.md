...
> *scope*, not its content. When writing `018-snowflakeaccount-controller.md`, the sole sources of
> truth are `specs/design.md` and the prompt given at spec-writing time — rework, restructure, or
> discard anything below freely. This file does not need to be kept up to date, and should be
> deleted once `018-snowflakeaccount-controller.md` has been written.
