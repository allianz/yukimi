...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,yukimi}
...
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SECRET-NAME",type="string",JSONPath=".spec.credentials.secretRef.name",priority=1
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,yukimi}
// A ClusterProviderConfig configures a Yukimi provider.
